...
clear @a[scores={tool_pickaxe_home_1=1..}] stone_pickaxe[lore=[{"text":"Open stone pickaxe page.","color":"gray","italic":false}]]
clear @a[scores={tool_pickaxe_home_2=1..}] iron_pickaxe[lore=[{"text":"Open iron pickaxe page.","color":"gray","italic":false}]]
clear @a[scores={tool_pickaxe_home_3=1..}] diamond_pickaxe[lore=[{"text":"Open diamond pickaxe page.","color":"gray","italic":false}]]
clear @a[scores={tool_pickaxe_home_4=1..}] netherite_pickaxe[lore=[{"text":"Open netherite pickaxe page.","color":"gray","italic":false}]]