...
clear @a[scores={potion_home_1=1..}] potion{display:{Lore:['{"text":"Open potion page.","color":"gray","italic":false}']}}
clear @a[scores={potion_home_2=1..}] splash_potion{display:{Lore:['{"text":"Open splash potion page.","color":"gray","italic":false}']}}
