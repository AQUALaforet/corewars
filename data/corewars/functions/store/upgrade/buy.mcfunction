...
clear @a[scores={upgrade_1_1=1..}] beacon{display:{Name:'{"text":"Haste","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"0","color":"red","italic":false}]','{"text":"[Diamond:15]","color":"aqua","italic":false}']}}
clear @a[scores={upgrade_1_2=1..}] beacon{display:{Name:'{"text":"Haste","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"1","color":"yellow","italic":false}]','{"text":"[Emerald:15]","color":"green","italic":false}']}}

clear @a[scores={upgrade_2_1=1..}] beacon{display:{Name:'{"text":"Healthboost","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"0","color":"red","italic":false}]','{"text":"[Diamond:15]","color":"aqua","italic":false}']}}
clear @a[scores={upgrade_2_2=1..}] beacon{display:{Name:'{"text":"Healthboost","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"1","color":"yellow","italic":false}]','{"text":"[Emerald:15]","color":"green","italic":false}']}}
clear @a[scores={upgrade_2_3=1..}] beacon{display:{Name:'{"text":"Healthboost","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"2","color":"green","italic":false}]','{"text":"[Netherite:15]","color":"gray","italic":false}']}}

clear @a[scores={upgrade_3_1=1..}] beacon{display:{Name:'{"text":"Resistance","italic":false}',Lore:['[{"text":"Current level:","color":"gray","italic":false},{"text":"0","color":"red","italic":false}]','{"text":"[Emerald:15]","color":"green","italic":false}']}}