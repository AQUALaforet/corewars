...
clear @a[scores={food_3=1..}] carrot{display:{Lore:['{"text":"[Iron:8]","color":"white","italic":false}']}}
clear @a[scores={food_4=1..}] apple{display:{Lore:['{"text":"[Iron:12]","color":"white","italic":false}']}}
clear @a[scores={food_5=1..}] baked_potato{display:{Lore:['{"text":"[Gold:2]","color":"gold","italic":false}']}}
clear @a[scores={food_6=1..}] cooked_chicken{display:{Lore:['{"text":"[Gold:4]","color":"gold","italic":false}']}}
clear @a[scores={food_7=1..}] pumpkin_pie{display:{Lore:['{"text":"[Gold:4]","color":"gold","italic":false}']}}
clear @a[scores={food_8=1..}] rabbit_stew{display:{Lore:['{"text":"[Diamond:1]","color":"aqua","italic":false}']}}
clear @a[scores={food_9=1..}] golden_carrot{display:{Lore:['{"text":"[Emerald:1]","color":"green","italic":false}']}}