...
scoreboard players remove @a[scores={armor_chestplate_chainmail_1=1..,iron_mine=40..}] iron_mine 40
scoreboard players remove @a[scores={armor_chestplate_chainmail_2=1..,iron_mine=50..}] iron_mine 50
scoreboard players remove @a[scores={armor_chestplate_chainmail_3=1..,gold_mine=20..}] gold_mine 20
scoreboard players remove @a[scores={armor_chestplate_chainmail_4=1..,gold_mine=30..}] gold_mine 30
scoreboard players remove @a[scores={armor_chestplate_chainmail_5=1..,gold_mine=40..}] gold_mine 40
